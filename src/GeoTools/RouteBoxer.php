...
class RouteBoxer
{
	 ...
	 * @param LatLngCollection $vertices The array of LatLngs representing the vertices of the path
	 * @param int $distance range The distance in kms around the route that the generated boxes must cover.
	 * @return array
	 */
